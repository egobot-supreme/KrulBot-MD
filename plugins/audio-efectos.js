...
if (err) return m.reply(`*❲⛔❳➤ 𝙾𝙲𝚄𝚁𝚁𝙸𝙾 𝚄𝙽 𝙴𝚁𝚁𝙾𝚁, 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝚃𝙴𝙽𝚃𝙰𝚁 𝙽𝚄𝙴𝚅𝙰𝙼𝙴𝙽𝚃𝙴, 𝙲𝙾𝙽 𝚄𝙽 𝙰𝚄𝙳𝙸𝙾 ❲MP3❳ 𝚂𝙸 𝙴𝙻 𝙿𝚁𝙾𝙱𝙻𝙴𝙼𝙰 𝚂𝙸𝙶𝚄𝙴, 𝚁𝙴𝙿𝙾𝚁𝚃𝙴 𝙴𝙻 𝙲𝙾𝙳𝙸𝙶𝙾 𝙲𝙾𝙽 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾: ${usedPrefix + command}*`)
let buff = await readFileSync(filename)
conn.sendFile(m.chat, buff, ran, null, m, true, {
type: 'audioMessage', 
ptt: true 
})})
} else return m.reply(`*❲⛔❳➤ 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 𝚁𝙴𝚂𝙿𝙾𝙽𝙳𝙰 𝙰 𝚄𝙽 𝙰𝚄𝙳𝙸𝙾 𝙿𝙰𝚁𝙰 𝙰𝙶𝚁𝙴𝙶𝙰𝚁 𝙴𝙻 𝙴𝙵𝙴𝙲𝚃𝙾 𝙳𝙴 𝚂𝙾𝙽𝙸𝙳𝙾, 𝚄𝚂𝙰𝙽𝙳𝙾 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙾 𝙲𝙾𝙼𝙾 𝙴𝙹𝙴𝙼𝙿𝙻𝙾: ${usedPrefix + command}*`)
} catch (e) {
