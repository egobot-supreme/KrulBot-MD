...
if (!text) throw `${lenguajeEB['smsAvisoMG']()}𝙀𝙎𝘾𝙍𝙄𝘽𝘼 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝙊 𝙏𝙄𝙏𝙐𝙇𝙊\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊\n*${usedPrefix + command} Billie Eilish - Bellyache*\n\n𝙒𝙍𝙄𝙏𝙀 𝙏𝙃𝙀 𝙉𝘼𝙈𝙀 𝙊𝙍 𝙏𝙄𝙏𝙇𝙀\n𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} Billie Eilish - Bellyache*`
try {
...
additionalText = '𝐕𝐈𝐃𝐄𝐎 ✅'}
let captionvid = `╭✿ ----------------- ❬╭🔥╮❭ ------------------ ✿
│ 🎀 𝙋𝙡𝙖𝙮 𝙆𝙧𝙪𝙡𝘽𝙤𝙩-𝙈𝘿 𝙊𝙛𝙞𝙘𝙞𝙖𝙡 🎀
╰✿ ----------------- ❬╰🔥╯❭ ------------------ ✿
...
╭✿ ----------------- ❬╭👑╮❭ ------------------ ✿
│⬇️ 𝘾𝙤𝙢𝙚𝙣𝙯𝙖𝙣𝙙𝙤 𝙘𝙤𝙣 𝙡𝙖 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖 ⬇️
┝▫▫▫▫▫▫▫▫▫▹
│𝙁𝙤𝙧𝙢𝙖𝙩𝙤: ${additionalText}
┝▫▫▫▫▫▫▫▫▫▹
│𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝘽𝙤𝙩: ${vs} ✅
┝▫▫▫▫▫▫▫▫▫▹
│𝙉𝙖𝙢𝙚: ${wm}
┝▫▫▫▫▫▫▫▫▫▹
│𝘾𝙧𝙚𝙖𝙙𝙤𝙧𝙖: 🍰⃟ཱི࿆𝙰𝚖𝚢Co͢nej͢itaᬽ🍰
╰✿ ----------------- ❬╰👑╯❭ ------------------ ✿`  
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `┏═━═━═━═━ೋ ⟬💐⟭ ೬ ೂ━═━═━═━═┓\n║𖥨ํ∘̥⃟⸽⃟🌹➮ 𝐓𝐈𝐓𝐔𝐋𝐎 / 𝐍𝐎𝐌𝐁𝐑𝐄:\n║➮ ${ttl}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟👑➮ 𝐍𝐎𝐌𝐁𝐑𝐄 𝐁𝐎𝐓:\n║➮ ${wm}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟🚀➮ 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 𝐁𝐎𝐓:\n║➮ ${vs}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟🎀➮ 𝐂𝐑𝐄𝐀𝐃𝐎𝐑𝐀:\n║➮ 🍰⃟ཱི࿆𝙰𝚖𝚢Co͢nej͢itaᬽ🍰\n┗═━═━═━═━ೋ ⟬💐⟭ ೬ ೂ━═━═━═━═┛`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {   
try {  
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `┏═━═━═━═━ೋ ⟬🍁⟭ ೬ ೂ━═━═━═━═┓\n║𖥨ํ∘̥⃟⸽⃟🌻➮ 𝐓𝐈𝐓𝐔𝐋𝐎 / 𝐍𝐎𝐌𝐁𝐑𝐄:\n║➮ ${n}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟🍀➮ 𝐍𝐎𝐌𝐁𝐑𝐄 𝐁𝐎𝐓:║➮ ${wm}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟🌠➮ 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 𝐁𝐎𝐓:\n║➮ ${vs}\n╠┈┈┈┈┈┈┈┈┈┈┈┈┈▻\n║𖥨ํ∘̥⃟⸽⃟🌻➮ 𝐂𝐑𝐄𝐀𝐃𝐎𝐑𝐀:\n║➮ 🍰⃟ཱི࿆𝙰𝚖𝚢Co͢nej͢itaᬽ🍰\n┗═━═━═━═━ೋ ⟬🍁⟭ ೬ ೂ━═━═━═━═┛`, thumbnail: await fetch(n4) }, { quoted: m })
} catch {
}}}    
}} catch {
handler.limit = 0
