...
let set
function replyToAudio() { m.reply(lenguajeEB.smsControlAudio1())}
function replyToNumber() { m.reply(lenguajeEB.smsControlAudio2(usedPrefix, command))}
        
// -- bass -- //
if (/edit(ed|ar)?bass/.test(command)) {
if (!args[0] || !args[1]) return  m.reply(lenguajeEB.smsAudioEdit1(usedPrefix, command))
...
m.reply(`*❲🚀❳➤ ${lenguajeEB.smsControlAudio5()}*\n\`\`\`${set.replace(/:/g, ':\n')}\`\`\`\n1️⃣ *${f}* 2️⃣ *${g}* 3️⃣ *${width_type}* 4️⃣ *${width}*`)
}
        
// -- vibra -- //
if (/edit(ed|ar)?vibra/.test(command)) {
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit2(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let f, d
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit3(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit4(usedPrefix, command))
let atempo, asetrate
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0]) throw lenguajeEB.smsAudioEdit5(usedPrefix, command)
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit6(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit7(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
let tempo, setrate
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit8(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit9(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit10(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()  
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit11(usedPrefix, command))
if (isNaN(args[0]) || isNaN(args[1])) return replyToNumber()
if (!mime) return replyToAudio()
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit12(usedPrefix, command))
...
if (!args[0] || !args[1]) return m.reply(lenguajeEB.smsAudioEdit13(usedPrefix, command))
...
if (err) return m.reply(lenguajeEB.smsControlAudio3())
let buff = await readFileSync(filename)
conn.sendFile(m.chat, buff, ran, null, m, true, {
type: 'audioMessage', 
ptt: true 
})})
} else return m.reply(lenguajeEB.smsControlAudio4())
} catch (e) {
return e
}}
