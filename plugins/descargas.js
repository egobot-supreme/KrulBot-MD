...
switch (true) {     
case isCommand1:
if (!text) return m.reply(lenguajeEB.smsMalused2() + `\n*${usedPrefix + command} perritos tiernos*`)
...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return m.reply('⚠️ 𝗘𝗥𝗥𝗢𝗥 ⚠️')      
try{
    
const res = await googleImage(text)
let image = res.getRandom()
let link = image
conn.sendFile(m.chat, link, 'error.jpg', `${lenguajeEB.smsImageGg()} ${text}`, m)
} catch (e) {
reportError(e)
} 
break
...
case isCommand2:
if (!text) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command} Billie Eilish - Bellyache*`)
try{    
if (command == 'play') {
let fkontak2 = { key: { participant: '0@s.whatsapp.net' }, message: { contactMessage: { displayName: '🔊💘 Enviando Audio 😍', vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;${author},;;;\nFN:${author},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, jpegThumbnail: fs.readFileSync('./media/menus/Menu1.jpg'), thumbnail: fs.readFileSync('./media/menus/Menu1.jpg'), sendEphemeral: true }}} 
let vid = (await yts(text)).all[0]
const yt_play = await search(args.join(" "))
if (!yt_play) return m.reply(lenguajeEB.smsMalError2() + `_${lenguajeEB.smsYT6()}_`)
let { title, description, url, thumbnail, videoId, timestamp, views, published } = vid
let video = `*╔═══❖•ೋ°ৡৢ͜͡  💎 𖥨֗°ೋ•❖═══╗*
   ᬊ᭄ঔৣ͜͡ீ͜❥͜❤️ 𝒀𝑶𝑼 𝑻𝑼𝑩𝑬 ❤️ू ፝͜❥ᬊ᭄
*╚═══❖•ೋ°ৡৢ͜͡  💎 𖥨֗°ೋ•❖═══╝*

⁖ฺ۟̇࣪·֗٬̤⃟💦➤ *${lenguajeEB.smsYT1()}*
ू ፝͜❥➤ ${yt_play[0].title}

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟👑➤ *${lenguajeEB.smsYT3()}*
ू ፝͜❥➤ ${secondString(yt_play[0].duration.seconds)}

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟👀➤ *${lenguajeEB.smsYT4()}*
ू ፝͜❥➤ ${MilesNumber(yt_play[0].views)}

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟⬇️➤ *𝐄𝐧𝐥𝐚𝐜𝐞 / 𝐔𝐑𝐋:*
ू ፝͜❥➤ ${yt_play[0].url}

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟💚➤ 𝐍𝐨𝐦𝐛𝐫𝐞 𝐁𝐨𝐭:
ू ፝͜❥➤ 𝑲𝒓𝒖𝒍𝑩𝒐𝒕-𝑴𝑫 💘

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟🥏➤ 𝐀𝐬𝐢𝐬𝐭𝐞𝐧𝐜𝐢𝐚 𝐁𝐨𝐭:
ू ፝͜❥➤ wa.me/5493873687620
...
*╔═══❖•ೋ°ৡৢ͜͡  💎 𖥨֗°ೋ•❖═══╗*
  ᬊ᭄ঔৣ͜͡ீ͜❥͜❤️ 𝑨𝑼𝑫𝑰𝑶 𝑩𝑶𝑻 ❤️ू ፝͜❥ᬊ᭄
*╚═══❖•ೋ°ৡৢ͜͡  💎 𖥨֗°ೋ•❖═══╝*
💘 𝙋𝙤𝙧 𝙛𝙖𝙫𝙤𝙧 𝙨𝙚𝙖 𝙥𝙖𝙘𝙞𝙚𝙣𝙩𝙚, 𝙨𝙚 𝙚𝙨𝙩𝙖 𝙚𝙣𝙫𝙞𝙖𝙣𝙙𝙤 𝙨𝙪 𝙖𝙪𝙙𝙞𝙤, 𝙚𝙨𝙥𝙚𝙧𝙚 𝙪𝙣𝙤𝙨 𝙨𝙚𝙜𝙪𝙣𝙙𝙤𝙨.
...
if (command == 'play2') {
let fkontak2 = { key: { participant: '0@s.whatsapp.net' }, message: { contactMessage: { displayName: '🏖️💘 Enviando Video 😍', vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;${author},;;;\nFN:${author},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, jpegThumbnail: fs.readFileSync('./media/menus/Menu1.jpg'), thumbnail: fs.readFileSync('./media/menus/Menu1.jpg'), sendEphemeral: true }}} 
let vid = (await yts(text)).all[0]
const yt_play = await search(args.join(" "))
if (!yt_play) return m.reply(lenguajeEB.smsMalError2() + `_${lenguajeEB.smsYT6()}_`)
let { title, description, url, thumbnail, videoId, timestamp, views, published } = vid
let video = `*╔═══❖•ೋ°ৡৢ͜͡  🎀 𖥨֗°ೋ•❖═══╗*
   ᬊ᭄ঔৣ͜͡ீ͜❥͜💜 𝒀𝑶𝑼 𝑻𝑼𝑩𝑬 💜ू ፝͜❥ᬊ᭄
*╚═══❖•ೋ°ৡৢ͜͡  🎀 𖥨֗°ೋ•❖═══╝*
...
*╔═══❖•ೋ°ৡৢ͜͡  🎀 𖥨֗°ೋ•❖═══╗*
  ᬊ᭄ঔৣ͜͡ீ͜❥͜💜 𝑽𝑰𝑫𝑬𝑶 𝑩𝑶𝑻 💜ू ፝͜❥ᬊ᭄
*╚═══❖•ೋ°ৡৢ͜͡  🎀 𖥨֗°ೋ•❖═══╝*
💚 𝙋𝙤𝙧 𝙛𝙖𝙫𝙤𝙧 𝙨𝙚𝙖 𝙥𝙖𝙘𝙞𝙚𝙣𝙩𝙚, 𝙨𝙚 𝙚𝙨𝙩𝙖 𝙚𝙣𝙫𝙞𝙖𝙣𝙙𝙤 𝙨𝙪 𝙫𝙞𝙙𝙚𝙤, 𝙚𝙨𝙥𝙚𝙧𝙚 𝙪𝙣𝙤𝙨 𝙨𝙚𝙜𝙪𝙣𝙙𝙤𝙨.
...
case isCommand4:
if (!args[0]) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command} https://youtu.be/ejemplo*\n*${usedPrefix + command} https://www.youtube.com/ejemplo*`)
...
await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `*❤️ ${ttl}*${size !== undefined ? `\n*⚖️ ${size}*` : ''}`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {
try {
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `*❤️ ${n}*${n3 !== undefined ? `\n*💜 ${n3}*` : ''}`, thumbnail: await fetch(n4) }, { quoted: m })
} catch (e) {
reportError(e)}}     
break
...
if (!args[0].match(/www.facebook.com|fb.watch|web.facebook.com|business.facebook.com|video.fb.com/g)) throw lenguajeEB.smsAvisoFG() + lenguajeEB.smsyFBvid1()
await m.reply(wait)
let messageType = checkMessageType(args[0])
let message = ''
switch (messageType) {
case "groups":
message = lenguajeEB.smsyFBvid2()
break
case "reel":
message = lenguajeEB.smsyFBvid3()
break
case "stories":
message = lenguajeEB.smsyFBvid4()
break
case "posts":
message = lenguajeEB.smsyFBvid5()
break
default:
message = lenguajeEB.smsyFBvid6()
break
}  
try {
...
case isCommand9:
if (!args[0]) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command} https://www.mediafire.com/file/04kaaqx9oe3tb8b/DOOM_v13_CLONE%255BCOM.FM%255D.apk/file*`)
try {  
let res = await mediafireDl(args[0])
let { name, date, mime, link, size:peso } = res
let caption = `*╔═══❖•ೋ°ৡৢ͜͡  ⬇️ 𖥨֗°ೋ•❖═══╗*
...
if (!/(?:https:?\/{2})?(?:w{3}|vm|vt|t)?\.?tiktok.com\/([^\s&]+)/gi.test(text)) return conn.reply(m.chat, `${lenguajeEB['smsAvisoFG']()}*${lenguajeEB['smsYT6']()}*`, m)  
try {
const { author: { nickname }, video, description, audio } = await tiktokdl(args[0])
.catch(async _ => await tiktokdlv2(args[0]))
.catch(async _ => await tiktokdlv3(args[0]))
const url = video.no_watermark2 || video.no_watermark || 'https://tikcdn.net' + video.no_watermark_raw || video.no_watermark_hd
await conn.reply(m.chat, `${lenguajeEB['smsAvisoEG']()}*${lenguajeEB['smsTiktok']()}*`, m)    
...
ttl = await yt.title;
await conn.sendMessage(m.chat, { document: { url: dl_url }, caption: `*💞 ${ttl}*\n*🥏 ${size == '720p' ? 'HD' : size == '1080p' ? 'FULL HD' : size == '1440p' ? '2K' : '4K'}*`, mimetype: 'video/mp4', fileName: ttl + `.mp4`}, {quoted: m})
} catch (e) {
reportError(e)
}        
break
...
text = m.quoted.text
} else return conn.reply(m.chat, `${lenguajeEB['smsMalused3']()}\n*${usedPrefix + command} ${lenguajeEB.smsIAimage4()}*`, m)
m.reply(wait)
try {
await Draw(text).then((img) => {
conn.sendFile(m.chat, img, 'image.jpg', lenguajeEB.smsIAimage3() + `\n\n_${text}_`, m)
})
} catch (e) {
reportError(e)}        
break
...
case isCommand15:
if (!text) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command} Runaway*\n\n*${usedPrefix + command} https://open.spotify.com/track/23rdcrD0Eky4vYn2TZidxJ*\n\n${lenguajeEB.smsSP0(usedPrefix)}`)
try {
...
let spotifyi = `*╔═══❖•ೋ°ৡৢ͜͡  🍏 𖥨֗°ೋ•❖═══╗*
 ᬊ᭄ঔৣ͜͡ீ͜❥͜🌇 𝐒 𝐏 𝐎 𝐓 𝐈 𝐅 𝐘  🌇ू ፝͜❥ᬊ᭄
*╚═══❖•ೋ°ৡৢ͜͡  🍏 𖥨֗°ೋ•❖═══╝*

⁖ฺ۟̇࣪·֗٬̤⃟💎➤ ${lenguajeEB.smsSP1()}
ू ፝͜❥➤ _${spty.data.name}_

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟👑➤ ${lenguajeEB.smsSP2()}
ू ፝͜❥➤ _${spty.data.artists}_

•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••

⁖ฺ۟̇࣪·֗٬̤⃟😍➤ ${lenguajeEB.smsSP3()}
ू ፝͜❥➤ _${linkDL}_
...
*╚═══❖•ೋ°ৡৢ͜͡  🍏 𖥨֗°ೋ•❖═══╝*`
await m.reply(wait)
await conn.sendFile(m.chat, spty.data.cover_url, 'image.jpg', '💜 𝐊𝐑𝐔𝐋 𝐁𝐎𝐓 𝐌𝐃 𝐎𝐅𝐈𝐂𝐈𝐀𝐋 💜\n\n' + spotifyi, m)
...
case isCommand16:
if (!text) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command} Bellyache*`)
let res = await fetch(`https://api.lolhuman.xyz/api/spotifysearch?apikey=${lolkeysapi}&query=${encodeURIComponent(text)}`)
let json = await res.json()
if (json.status != '200') return m.reply(lenguajeEB.smsSP6())
try{
let get_result = json.result
let ini_txt = `⁖ฺ۟̇࣪·֗٬̤⃟✅➤ \`\`\`${text}\`\`\``
for (var sh of get_result) {
const duration = sh.duration
const formatted = formatVideoDuration(duration)
ini_txt += `\n\n⁖ฺ۟̇࣪·֗٬̤⃟💚➤ ${lenguajeEB.smsSP1()} \nू ፝͜❥➤ ${sh.title}\nू ፝͜❥➤ ${formatted}\n•┈┈┈•••┈┈┈•\n`
ini_txt += `⁖ฺ۟̇࣪·֗٬̤⃟👑➤ ${lenguajeEB.smsSP2()} \nू ፝͜❥➤ ${sh.artists}\n•┈┈┈•••┈┈┈•\n`
ini_txt += `⁖ฺ۟̇࣪·֗٬̤⃟⬇️➤ ${lenguajeEB.smsSP3()} \nू ፝͜❥➤ ${sh.link}\n•┈┈┈•••┈┈┈•\n`
ini_txt += `⁖ฺ۟̇࣪·֗٬̤⃟💜➤ 𝐍𝐨𝐦𝐛𝐫𝐞 𝐁𝐨𝐭:\nू ፝͜❥➤ 𝐾𝑟𝑢𝑙𝐵𝑜𝑡-𝑀𝐷\n\n⁖ฺ۟̇࣪·֗٬̤⃟🥏➤ 𝐀𝐬𝐢𝐬𝐭𝐞𝐧𝐜𝐢𝐚 𝐁𝐨𝐭\nू ፝͜❥➤ wa.me/5493873687620\n\n`
ini_txt += `•┈┈┈•••┈┈┈••✦✨✦••┈┈┈••┈┈┈••`
}
await m.reply(wait)
...
case isCommand17:
if (!args[0]) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command}* ` + 'https://www.instagram.com/reel/CrWooCiKGKP/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')
try{
let human = await fetch(`https://api.lolhuman.xyz/api/instagram?apikey=${lolkeysapi}&url=${args[0]}`)
let json3 = await human.json()
let ig_ = json3.result
let shortUrl1 = await (await fetch(`https://tinyurl.com/api-create.php?url=${args[0]}`)).text()
let txt1 = `⬇️ *𝐄𝐍𝐋𝐀𝐂𝐄 / 𝐔𝐑𝐋:*\nू ፝͜❥➤ ${shortUrl1}`.trim()
await m.reply(wait)
try{
...
if (!text) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command}* ` + 'https://twitter.com/gofoodindonesia/status/1229369819511709697')
try{ 
...
case isCommand19:
if (!text) return m.reply(lenguajeEB.smsMalused2() + `*${usedPrefix + command}* ${md}`)
//await m.reply(`*${lenguajeEB.smsGit()}*`);
conn.reply(m.chat, `${lenguajeEB.smsAvisoEG()} ${lenguajeEB.smsGit()}`, m, {
contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, 
title: igfg, 
body: '𝗦𝗨𝗣𝗘𝗥 𝗕𝗢𝗧 𝗗𝗘 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣',         
previewType: 0, thumbnail: fs.readFileSync("./media/menus/Menu2.jpg"),
sourceUrl: `https://github.com/ReyCreator-Official/KrulBot-MD`}}})
...
return { error: '⛔ 𝙊𝙘𝙪𝙧𝙧𝙞𝙤 𝙪𝙣 𝙚𝙧𝙧𝙤𝙧 𝙞𝙣𝙚𝙨𝙥𝙚𝙧𝙖𝙙𝙤 𝙚𝙣 𝙡𝙖 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖.' }})
