...
const smsMalused2 = () => { return `${lenguajeEB['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH SEPERTI DALAM CONTOH INI:*\n`}
const smsMalused3 = () => { return `${lenguajeEB['smsAvisoMG']()}🐈 *BALAS PESAN DENGAN PERINTAH ATAU GUNAKAN CONTOH INI:*\n`}

//Error
const smsMalError = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`TERJADI KESALAHAN YANG TIDAK TERDUGA.\`\`\``}
const smsMalError2 = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`TIMBUL KETIDAKMURAN.\`\`\`\n`}
const smsMalError3 = () => { return `${lenguajeEB['smsAvisoFG']()}\`\`\`ADA YANG SALAH, LAPORAN PERINTAH INI MENGGUNAKAN:\`\`\`\n`}
...
//convertidores.js
const smsToimg = () => { return lenguajeEB.smsAvisoMG() + '*TANGGAPI STIKER UNTUK MENGUBAH KE GAMBAR*'} 

//convertidores.js
const smsConURL = () => { return lenguajeEB.smsAvisoMG() + '*TANGGAPI GAMBAR UNTUK DIKONVERSI KE LINK*'} 
...
//convertidores.js
const smsConVIDEO = () => { return lenguajeEB.smsAvisoMG() + '*RESPONS TO MOTION STICKER UNTUK MENGUBAH KE VIDEO*'} 
const smsConVIDEO2 = () => { return lenguajeEB.smsAvisoMG() + '*STIKER HANYA BERGERAK UNTUK DIKONVERSI KE VIDEO*'} 
const smsConVIDEO3 = () => { return lenguajeEB.smsAvisoEG() + '*✓ DI SINI ANDA MEMILIKI VIDEO ANDA!!*'} 

//convertidores.js
const smsConGIF = () => { return lenguajeEB.smsAvisoMG() + '*BALAS KE VIDEO UNTUK MENGUBAH KE GIF DENGAN AUDIO*'} 
const smsConGIF2 = () => { return lenguajeEB.smsAvisoMG() + '*TANGGAPAN VIDEO. JENIS FILE YANG DIGUNAKAN TIDAK BENAR* '} 
const smsConGIF3 = () => { return lenguajeEB.smsAvisoEG() + '*GIF DENGAN AUDIO (Buka gif untuk mendengarkan audio)*'} 

//convertidores.js
const smsConVN = () => { return lenguajeEB.smsAvisoMG() + '*BALAS KE VIDEO ATAU AUDIO UNTUK MENGUBAH KE CATATAN SUARA*'} 
const smsConVN1 = () => { return lenguajeEB.smsAvisoFG() + '*ADA YANG SALAH DENGAN VIDEONYA, COBA LAGI*'} 
const smsConVN2 = () => { return lenguajeEB.smsAvisoFG() + '*ADA YANG SALAH DENGAN AUDIO, COBA LAGI*'} 
const smsConVN3 = () => { return lenguajeEB.smsAvisoFG() + '*ADA YANG SALAH SAAT MENCOBA MENGUBAH AUDIO ANDA MENJADI MEMO SUARA*'}
const smsConVN4 = () => { return lenguajeEB.smsAvisoFG() + '*ADA YANG SALAH SAAT MENCOBA MENGUBAH VIDEO ANDA MENJADI MEMO SUARA*'} 

//convertidores.js
const smsTradc1 = () => { return lenguajeEB.smsAvisoMG() + '*BALAS PESAN TEKS ATAU KETIK KODE DAN TEKS UNTUK MENGUBAH KE AUDIO, CONTOH:*\n'}
const smsTradc2 = () => { return ' (kode) (teks)\n'} 
const smsTradc3 = () => { return lenguajeEB.lenguaje() + ' Teks ini akan menjadi audio\n\n'}
...
//grupos-admins.js
const smsSetW = () => { return `${lenguajeEB['smsAvisoEG']()}*SAMBUTAN GRUP TELAH DIATUR*`}
const smsSetW2 = () => { return `${lenguajeEB['smsAvisoIIG']()}🙌 *_TULIS PESAN SELAMAT DATANG_*\n*_OPSIONAL ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n*⚡ @subject (Nama grup)*\n*⚡ @desc (Deskripsi grup)*\n\n*INGAT BAHWA "@" ADALAH OPSIONAL*`}

//grupos-admins.js
const smsSetB = () => { return `${lenguajeEB['smsAvisoEG']()}*PERPISAHAN GRUP TELAH DIKONFIGURASI*`}
const smsSetB2 = () => { return `${lenguajeEB['smsAvisoIIG']()}🙌 *_TULIS PESAN PERPISAHAN_*\n*_OPSIONAL ANDA DAPAT MENGGUNAKAN APA DENGAN "@" UNTUK MENAMBAHKAN INFORMASI LEBIH LANJUT:_*\n\n*⚡ @user (Sebutkan kepada pengguna)*\n\n*INGAT BAHWA "@" ADALAH OPSIONAL*`}

//grupos-admins.js
const smsDest = () => { return `${lenguajeEB['smsAvisoEG']()}*DESKRIPSI GRUP TELAH DIKONFIGURASI*`}

//grupos-admins.js
const smsNam1 = () => { return `${lenguajeEB['smsAvisoEG']()}*NAMA GRUP TELAH DITETAPKAN*`}
const smsNam2 = () => { return `${lenguajeEB['smsAvisoMG']()}*🙌 TULIS NAMA GRUP BARU*`}
const smsNam3 = () => { return `${lenguajeEB['smsAvisoFG']()}*NAMA GRUP TIDAK BOLEH MEMILIKI LEBIH DARI 25 KARAKTER*`}

//grupos-admins.js
const smsGrupoPP = () => { return `${lenguajeEB['smsAvisoMG']()}*RESPON GAMBAR UNTUK MENGUBAH FOTO GRUP*`}
const smsGrupoPP2 = () => { return `${lenguajeEB['smsAvisoEG']()}*🪄 GAMBAR GRUP DIPERBARUI!!*`}

//grupos-admins.js
const smsRestGp = () => { return `${lenguajeEB['smsAvisoEG']()}*TAUTAN GROUP TELAH DIATUR ULANG*`}

//grupos-admins.js
const smskick1 = () => { return `${lenguajeEB['smsAvisoAG']()}*TAG ORANG ATAU BALAS PESAN ORANG YANG INGIN ANDA HAPUS*\n\n*EJEMPLO: `}
...
const smsGrupoClose = () => { return `${lenguajeEB['smsAvisoEG']()}*GROUP TERTUTUP, HANYA ADMIN YANG BISA MENULIS!!*`}
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeEB['smsAvisoMG']()}*TAG SESEORANG ATAU BALAS PESAN PENGGUNA ATAU TULIS NOMOR YANG INGIN ANDA BALAS DARI PERINTAH*\n\n*CONTOH:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeEB['smsAvisoFG']()}*@${bot} TIDAK DAPAT DILARANG DENGAN PERINTAH INI* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeEB.smsAvisoIIG()}😳 *SAYA TIDAK BISA MELARKAN PEMILIK @${ownerNumber} DARI ${packname}*`}
const smsPropban4 = (number) => { return `${lenguajeEB.smsAvisoIIG()}*TIDAK PERLU BAN LAGI @${number} YA SUDAH ADA* 😊`}
const smsPropban5 = () => { return `${lenguajeEB['smsAvisoEG']()}*PENGGUNA BERHASIL DILARANG* 🙀`}
const smsPropban6 = (number, usr) => { return `${lenguajeEB.smsAvisoAG()}*@${number} ANDA DILARANG OLEH @${usr} ANDA TIDAK DAPAT MENGGUNAKAN PERINTAH HINGGA SESEORANG MEMBALIKKAN BAN* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${lenguajeEB['smsAvisoFG']()}*KESALAHAN MUNCUL, MUNGKIN PENGGUNA TIDAK DALAM DATABASE SAYA MENCOBA MENULIS ${usedPrefix + command} ${number}*\n\`\`\`JIKA KESALAHAN TERUS LANGSUNG LAPORKAN PERINTAH INI\`\`\``}

//owner-unbanuser.js
const smsPropdesban1 = (usedPrefix, command, bot) => { return `${lenguajeEB['smsAvisoMG']()}*TAG SESEORANG ATAU BALAS PESAN PENGGUNA ATAU TULIS NOMOR YANG INGIN ANDA UNBAN DARI PERINTAH*\n\n*CONTOH:*\n*${usedPrefix + command} @${bot}*`}
const smsPropdesban2 = (number) => { return `${lenguajeEB.smsAvisoIIG()}*TIDAK PERLU UNBAN LAGI @${number} YA SUDAH ADA* 😊`}
const smsPropdesban3 = () => { return `${lenguajeEB['smsAvisoEG']()}*USER UNBANED BERHASIL* 💙`}
const smsPropdesban4 = (number, usr) => { return `${lenguajeEB.smsAvisoAG()}*@${number} ANDA DIBUKA OLEH @${usr} ANDA SEKARANG DAPAT MENGGUNAKAN PERINTAH!!* 🪄`}
const smsPropdesban5 = (usedPrefix, command, number) => { return `${lenguajeEB['smsAvisoFG']()}*MUNCUL KESALAHAN, MUNGKIN PENGGUNA TIDAK ADA DI DATABASE SAYA COBA MENULIS ${usedPrefix + command} ${number}*\n\`\`\`JIKA KESALAHAN TERUS LANGSUNG LAPORKAN PERINTAH INI\`\`\``}
...
//owner-unbanchat.js
const smsUnbanCH1 = () => { return lenguajeEB['smsAvisoFG']() + '🗂️ *CHAT INI TIDAK TERDAFTAR DI DATABASE*'}
const smsUnbanCH2 = () => { return lenguajeEB.smsAvisoAG() + '🌹 *CHAT INI TIDAK DILARANG!!*'}
const smsUnbanCH3 = () => { return lenguajeEB['smsAvisoEG']() + '🪄 *CHAT INI TIDAK DIBANDINGKAN, ANDA SEKARANG DAPAT MENGGUNAKAN PERINTAH!!*'}
...
const smsBlockUn2 = (comd, ownerNumber) => { return lenguajeEB.smsAvisoAG() + `*TIDAK BISA ${comd} KEPADA PEMILIK @${ownerNumber}*`}
const smsBlockUn3 = (comd, useB) => { return `*TELAH ${comd} KE ${useB} BERHASIL*`}

//propietario(a).js
const smsRestarU1 = () => { return lenguajeEB['smsAvisoMG']() + '*LABEL PENGGUNA, TULIS NOMOR MEREKA, ATAU TANGGAPI PESAN UNTUK MULAI ULANG DATA*'}
const smsRestarU2 = () => { return lenguajeEB['smsAvisoFG']() + '*NOMOR YANG ANDA MASUKKAN TIDAK VALID UNTUK RESET DATA*'}
const smsRestarU3 = (number) => { return lenguajeEB['smsAvisoEG']() + `*SETEL ULANG KE @${number} DARI DATABASE*`}

//propietario(a).js
const smsJoin1 = (usedPrefix, command) => { return lenguajeEB['smsAvisoMG']() + `*MASUKKAN LINK GRUP*\n*CONTOH:*\n*${usedPrefix + command}* ${nna}`}
const smsJoin2 = () => { return lenguajeEB['smsAvisoEG']() + `${packname}\n*DIA TELAH BERGABUNG DENGAN GROUP ✅*`}

//info.js
const smsReportEB1 = (usedPrefix, command) => { return lenguajeEB['smsAvisoMG']() + `*MENULIS SEBUAH LAPORAN*\n*CONTOH:*\n\n*${usedPrefix + command}* _Perintah ${usedPrefix}play tidak bekerja._`}
const smsReportEB2 = () => { return lenguajeEB['smsAvisoFG']() + `✨ *MINIMAL 10 KARAKTER UNTUK MEMBUAT LAPORAN*`}
const smsReportEB3 = () => { return lenguajeEB['smsAvisoFG']() + `😼 *MAKSIMAL 1000 KARAKTER UNTUK MEMBUAT LAPORAN*`}
...
*⎔ Pesan:*
*» ${text}*`.trim()}
const smsReportEB5 = () => { return lenguajeEB['smsAvisoEG']() + `*LAPORAN TELAH DIKIRIM KE DEVELOPER, JIKA PERLU ANDA AKAN TANGGAPAN*`}
...
const smsSoloOwnerJB = () => { return `${lenguajeEB['smsAvisoAG']()}*PERINTAH INI DINONAKTIFKAN OLEH PEMILIK SAYA*`}
const smsJBPrincipal = () => { return `${lenguajeEB['smsAvisoAG']()}🔵 *UNTUK JADI SUB BOT MASUK KE NOMOR UTAMA*\n*ღ Masukkan tautan berikut:*\n`}
const smsJBConexion = () => { return `${lenguajeEB['smsAvisoFG']()}🟡 *KONEKSI TELAH DITUTUP SECARA TIDAK TERDUGA, KAMI AKAN MENCOBA UNTUK MENGHUBUNGKAN KEMBALI...*`}
const smsJBConexionClose = () => { return `${lenguajeEB['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS CONNECT MANUAL MENGGUNAKAN PERINTAH #jadibot DAN RESCAN QR CODE BARU${lenguajeEB['smsJBConexionTrue3']()}* *YANG DIKIRIM PERTAMA KALI SUB BOT DIBUAT*`}
const smsJBConexionTrue = () => { return `${lenguajeEB['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeEB['smsAvisoEG']()}🟢 *KONEKSI BERHASIL!!! ANDA DAPAT MENGHUBUNGKAN MENGGUNAKAN:*`}
const smsJBConexionTrue3 = () => { return `.`}
const smsJBCargando = (usedPrefix) => { return `${lenguajeEB['smsAvisoIIG']()}⚪ *TERHUBUNG!! SILAKAN TUNGGU PESAN SEDANG DIMUAT...*\n\n♻️ *PILIHAN YANG TERSEDIA:*\n*» ${usedPrefix}pausesb _(Hentikan Fitur Sub Bot)_*\n*» ${usedPrefix}delsession _(Hapus semua jejak Sub Bot)_*\n*» ${usedPrefix}jadibot _(Kode QR baru atau Login jika Anda sudah menjadi Jadi Bot)_*`}

//jadibot
const smsJBDel = () => { return `${lenguajeEB['smsAvisoAG']()}*GUNAKAN PERINTAH INI KE BOT UTAMA*`}
const smsJBAdios = () => { return `${lenguajeEB['smsAvisoEG']()}*AKU AKAN MERINDUKANMU ${global.packname} SELAMAT TINGGAL!! 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeEB['smsAvisoEG']()}*ANDA TELAH KELUAR DAN MENGHAPUS SEMUA JEJAK*`}
...
//jadibot
const smsJBCom1 = () => { return lenguajeEB['smsAvisoAG']() + `*JIKA ANDA BUKAN SUB BOT, HUBUNGI NOMOR UTAMA UNTUK MENJADI SUB BOT*`}
const smsJBCom2 = () => { return lenguajeEB['smsAvisoRG']() + `*ANDA TELAH MENUTUP/MENJEDA SESI.*`}
...
//rpg-verificar.js
const smsVerify0 = (usedPrefix) => { return `${lenguajeEB['smsAvisoIIG']()}*ANDA SUDAH TERDAFTAR!!*\n*JIKA ANDA INGIN MEMBATALKAN PENDAFTARAN ANDA GUNAKAN PERINTAH INI*\n*${usedPrefix}unreg nomor seri*\n\n*JIKA ANDA TIDAK INGAT NOMOR SERI ANDA GUNAKAN PERINTAH INI*\n*${usedPrefix}myns`}
const smsVerify1 = (usedPrefix, command) => { return `${lenguajeEB['smsAvisoIIG']()}*MASUKKAN NAMA DAN UMUR ANDA UNTUK DAFTAR*\n*CONTOH*\n\n${usedPrefix + command} GataBot.18`}
const smsVerify2 = () => { return `${lenguajeEB['smsAvisoAG']()}*MASUKKAN NAMA ANDA*`}
const smsVerify3 = () => { return `${lenguajeEB['smsAvisoAG']()}*MASUKKAN UMUR ANDA*`}
const smsVerify4 = () => { return `${lenguajeEB['smsAvisoAG']()}*ANDA SANGAT TUA*`}
const smsVerify5 = () => { return `${lenguajeEB['smsAvisoAG']()}*ANDA SANGAT MINOR*`}
const smsVerify6 = () => { return `${lenguajeEB['smsAvisoAG']()}*TULIS NAMA YANG LEBIH PENDEK*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeEB['smsAvisoEG']()}*SEBAGAI ADMIN TIDAK AKAN DIHAPUS*`}
const smsEnlaceWat = () => { return `${lenguajeEB['smsAvisoAG']()}*LINK WHATSAPP TERDETEKSI!!*\n\n*ANDA AKAN DIHAPUS*`}
const smsWaMismoEnlace = () => { return '*LINK INI DARI GRUP INI, HANYA UNTUK ITU, TIDAK AKAN DIHAPUS*'}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeEB['smsAvisoAG']()}*TAUTAN YANG BERISI HTTPS TERDETEKSI!!*\n\n*ANDA AKAN DIHAPUS*`}
...
const smsCont7 = () => { return `${global.lenguajeEB['smsAvisoAG']()}*TIDAK MEMILIKI BERLIAN!! 💎 ANDA BISA PERGI KE TOKO DENGAN PERINTAH*`}
const smsCont8 = () => { return ` *BERLIAN 💎 DIGUNAKAN*`}
const smsCont9 = () => { return `${global.lenguajeEB['smsAvisoAG']()}*MEMBUTUHKAN TINGKAT ➡️*`}
...
const smsSP6 = () => { return `${lenguajeEB['smsAvisoFG']()}*TIDAK ADA HASIL YANG DITEMUKAN. COBA NAMA ATAU LINK LAIN*`} 
